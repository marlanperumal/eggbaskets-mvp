...
const assetSchema = z.object({
    name: z.string(),
    type: z.enum(["Fixed Appreciating", "Fixed Depreciating", "Investment", "Retirement Savings", "Other"]),
...
export function AssetDetails({ assetId, onClose }: AssetDetailsProps) {
    ...
    return (
        <DialogContent>
            <DialogHeader>
                ...
                <DialogDescription>View your asset information</DialogDescription>
            </DialogHeader>
            <Form {...form}>
                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            <SelectItem value="Fixed Appreciating">Fixed Appreciating</SelectItem>
                                            <SelectItem value="Fixed Depreciating">Fixed Depreciating</SelectItem>
