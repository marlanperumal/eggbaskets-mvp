...
function ExpenseOptions({ expenseId }: { expenseId: string }) {
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            ...
            <DropdownMenuItem onClick={() => deleteExpense(expenseId)}>
              Delete
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
          ...
          <TableBody>
            {expenses.map((expense) => (
              <TableRow key={expense.id}>
                ...
                <TableCell className="hidden md:table-cell">{expense.startYear}</TableCell>
                <TableCell className="hidden md:table-cell">{expense.endYear}</TableCell>
                <TableCell className="hidden lg:table-cell">
                  {expense.annualGrowthRate}%
                </TableCell>
                <TableCell className="flex justify-center">
                  <ExpenseOptions expenseId={expense.id} />
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
